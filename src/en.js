...
Blockly.Msg.CALCIUM_ADD_TOOLTIP = 'Adds the value to the variable.'
...
Blockly.Msg.CALCIUM_ARITHMETIC_TOOLTIP = 'Calculates data from two values.'

Blockly.Msg.CALCIUM_ASSIGN_TITLE = 'assign to %1 from %2'
Blockly.Msg.CALCIUM_ASSIGN_TOOLTIP = 'Assigns the data to the variable.'

Blockly.Msg.CALCIUM_ATTRIBUTE_TITLE = "%1 's attribute %2"
Blockly.Msg.CALCIUM_ATTRIBUTE_TOOLTIP = 'Accesses the attribute of the object.'

Blockly.Msg.CALCIUM_BITWISE_TOOLTIP = 'Calculates each bit in the data.'

Blockly.Msg.CALCIUM_BITWISE_NOT_TOOLTIP = 'Reverses each bit in the data.'

Blockly.Msg.CALCIUM_BOOLEAN_TRUE = 'Yes'
Blockly.Msg.CALCIUM_BOOLEAN_FALSE = 'No'
Blockly.Msg.CALCIUM_BOOLEAN_TOOLTIP = 'Represents the value like "Yes" or "No".'

Blockly.Msg.CALCIUM_BREAK = 'break this loop'
Blockly.Msg.CALCIUM_CONTINUE = 'continue next loop'
Blockly.Msg.CALCIUM_BREAK_CONTINUE_TOOLTIP = 'Controls the loop.'

Blockly.Msg.CALCIUM_CALL_TITLE = 'call %1'
Blockly.Msg.CALCIUM_CALL_TOOLTIP = 'Calls a function or method.'
Blockly.Msg.CALCIUM_CALL_ARG_TITLE = 'argument'
Blockly.Msg.CALCIUM_CALL_ARG_TOOLTIP = 'The argument of the function call.'
Blockly.Msg.CALCIUM_CALL_RETURN_TITLE = '%1 = call %2'
Blockly.Msg.CALCIUM_CALL_RETURN_TOOLTIP =
  'Assigns the result of the function call to the variable.'

Blockly.Msg.CALCIUM_CLASS_TITLE = '%1 class'
Blockly.Msg.CALCIUM_CLASS_TOOLTIP =
  'Specifies the name of the class to be instantiated.'

Blockly.Msg.CALCIUM_CLASS_DEF_TITLE = 'define %1 class %2 inherit %3 %4'
Blockly.Msg.CALCIUM_CLASS_DEF_TOOLTIP = 'Defines a class.'

Blockly.Msg.CALCIUM_COMMA_TOOLTIP = 'Uses a pair of data.'

Blockly.Msg.CALCIUM_COMPOUND_ASSIGN_TOOLTIP =
  'Calculates and updates the variable.'
...
Blockly.Msg.CALCIUM_DEF_PARAM_TOOLTIP = 'The parameter of the function.'

Blockly.Msg.CALCIUM_DICT_TITLE = 'create a dict'
Blockly.Msg.CALCIUM_DICT_TOOLTIP = 'Creates an empty dict.'

Blockly.Msg.CALCIUM_EXPR_STMT_TOOLTIP = 'Calls the function and uses no result.'

Blockly.Msg.CALCIUM_FOR_TITLE = 'repeat %1 from %2 %3 %4'
Blockly.Msg.CALCIUM_FOR_TOOLTIP = 'Repeats by extracting data to the variable.'
...
Blockly.Msg.CALCIUM_FUNCTION_TOOLTIP = 'Specifies the name of the function.'
...
Blockly.Msg.CALCIUM_IF_ELSE_TOOLTIP = 'Executed when no condition has been met.'

Blockly.Msg.CALCIUM_IMPORT_TITLE = 'import %1'
Blockly.Msg.CALCIUM_IMPORT_TOOLTIP = 'Uses libraries or modules.'

Blockly.Msg.CALCIUM_KWARG_TOOLTIP = 'Gives a keyword argument to the function.'
...
Blockly.Msg.CALCIUM_LIST_ITEM_TOOLTIP = 'The element of the list.'

Blockly.Msg.CALCIUM_LOGICAL_AND = 'and'
Blockly.Msg.CALCIUM_LOGICAL_OR = 'or'
Blockly.Msg.CALCIUM_LOGICAL_TOOLTIP = 'Calculates boolean values logically.'

Blockly.Msg.CALCIUM_METHOD_TITLE = "%1 's %2 method"
Blockly.Msg.CALCIUM_METHOD_TOOLTIP = 'Specifies the name of the method.'

Blockly.Msg.CALCIUM_NONE_TOOLTIP = 'Represents "null" or "nothing".'

Blockly.Msg.CALCIUM_NOT_TITLE = 'not %1'
Blockly.Msg.CALCIUM_NOT_TOOLTIP = 'Negates the logical value.'

Blockly.Msg.CALCIUM_NUMBER_TOOLTIP = 'A number value.'

Blockly.Msg.CALCIUM_PASS_TOOLTIP = 'Does nothing.'
...
Blockly.Msg.CALCIUM_RELATIONAL_TOOLTIP =
  'Compares the two values and results a boolean.'

Blockly.Msg.CALCIUM_RETURN_TITLE = 'return %1 from this function'
Blockly.Msg.CALCIUM_RETURN_TOOLTIP =
  'Returns a value and ends the function call.'

Blockly.Msg.CALCIUM_SLICE_TITLE = 'slice %1 : %2'
Blockly.Msg.CALCIUM_SLICE_TOOLTIP = 'Slices the part of the list.'
...
Blockly.Msg.CALCIUM_VARIABLE_TOOLTIP = 'Specifies the name of the variable.'

Blockly.Msg.CALCIUM_WHILE_TITLE = 'while %1 %2 repeat %3'
Blockly.Msg.CALCIUM_WHILE_TOOLTIP = 'Repeats as long as the condition is met.'
